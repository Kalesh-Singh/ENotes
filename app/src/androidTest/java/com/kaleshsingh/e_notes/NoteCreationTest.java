...
public class NoteCreationTest {
    ...
    @Rule
    public ActivityTestRule<NoteListActivity> noteListActivity =
    ...
    public void createNewNote() {
        ...
        final String noteText = "This is the body text of our test note.";

//        ViewInteraction fabNewNote = onView(withId(R.id.fab));      // Gets the view (fab)
//        fabNewNote.perform(click());                                // Performs a click on the fab
